...
export interface AnalyzePhysiqueInput {
  ...
  posesProvided: Array<'front' | 'side' | 'back'>;
  userQuestion: string;
}
...
export function analyzePhysique(
  ...
  return {
    assessmentRubric: {
      ...
      voiceGuidance:
        'Confident on what is visible. Specific anatomical language. Explicit acknowledgment of limits ("from this angle I cannot see X"). One sentence at the end pointing the user to a qualified prep coach for definitive contest prep decisions.',
    },
    citations: [
